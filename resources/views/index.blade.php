...
<section class="hero-section" id="section_1">
    ...
    <div class="video-wrap">
        <video autoplay="" loop="" muted="" class="custom-video" poster="">
            <source src="../../public/video/pexels-2022395.mp4" type="video/mp4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                <div class="services-info">
                    ...
                    <p class="text-white">Festava Live is free CSS template provided by TemplateMo website. This
                        layout is built on Bootstrap v5.2.2 CSS library. You are free to use this template for your
            ...
            <div class="col-lg-6 col-12">
                <div class="about-text-wrap">
                    <img src="../../public/images/pexels-alexander-suhorucov-6457579.jpg"
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 col-12">
                <div class="artists-thumb">
                    <div class="artists-image-wrap">
                        <img src="../../public/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg"
            ...
            <div class="col-lg-5 col-12">
                <div class="artists-thumb">
                    <div class="artists-image-wrap">
                        <img src="../../public/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg"
                             class="artists-image img-fluid">
                    </div>
                ...
                <div class="artists-thumb">
                    <img src="../../public/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg"
                         class="artists-image img-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="pricing-thumb">
                    ...
                    <a class="link-fx-1 color-contrast-higher mt-4" href="ticket.blade.php">
